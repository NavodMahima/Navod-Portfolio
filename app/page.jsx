...
const handleDownload = () => {
  ...
  link.href = '/assets/resume/NavodMahima.pdf';  // Replace with the actual file path
  link.download = 'NavodMahima.pdf';  // Name of the file when downloaded
  link.click();
};
const Home = () => {
  return (
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
                             Hello I'm <br />
              <span className="text-accent">Navod Mahima</span>
            </h1>
